...
function WeatherInfoPage() {
  ...
  const fetchWeatherData = (city) => {
    ...
    /**
     * API weatherbit has a limit of 100 request per day. So,
     * i have mocked the response of the API in catch. It show same data
     * for all the cities.
     */
    fetch(
      `https://weatherbit-v1-mashape.p.rapidapi.com/forecast/daily?lon=${city.Longitude}&lat=${city.Latitude}&start_date=${today}&end_date=${lastDay}`,
      options
    )
